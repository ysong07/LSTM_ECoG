...
if __name__ == '__main__':
  ...
  model = ReadModelProto('models_joint4041_ensemble_upthreshold/lstm_combo_2layer_ecog_deploy.pbtxt')
  ...
  board = LockGPU(board=board_id)   
  model = ReadModelProto('models_joint4041_ensemble_downthreshold/lstm_combo_2layer_ecog_deploy.pbtxt')
  cm.CUDAMatrix.init_random(200)
  np.random.seed(200)
 ...
 # train_data_3 = ChooseDataHandler(ReadDataProto('datasets_joint4041/ecog.pbtxt'))
  ...
  for ii in xrange(1, 10000000): 
    ...
    if ii % 20000 ==1 :
      lstm_autoencoder_0.Save('models_joint_4041_ensemble/ensemble0_uncond_%s' % ii)
      lstm_autoencoder_1.Save('models_joint_4041_ensemble/ensemble1_uncond%s' % ii)
